...
public class WordAdapter<W> extends ArrayAdapter<Word> {
    ...
    private int colorId;
    public WordAdapter(NumbersActivity context, ArrayList<Word> linsOfNumbers, int color){
        super(context,0, linsOfNumbers);
        colorId = color;
    }
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        mivokTextView.setText(word.getMivokTransistion());
        ...
        englishTextView.setText(word.getEnglishTransistion());
